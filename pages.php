...
$db = getDbInstance();
$select = array('id', 'name', 'url_link','created_date');

// Start building query according to input parameters
// If search string
if ($search_str) {
	$db->where('name', '%' . $search_str . '%', 'like');
	$db->orwhere('url_link', '%' . $search_str . '%', 'like');
}
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['url_link']); ?></td>
            ...
            <!-- //Delete Confirmation Modal -->
            <?php endforeach; else:?>
            <tr><td colspan="6"><div class="alert alert-danger">No records found!</div></td></tr>
            <?php endif; ?>
